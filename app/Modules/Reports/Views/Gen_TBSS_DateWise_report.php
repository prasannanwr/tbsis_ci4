...
<div id="page-wrapper" class="largeRpt">
    ...
    <div class="alignRight"> 
        <form method="post" action="<?php echo site_url();?>/reports/Gen_TBSS_DateWise_print<?php echo (isset($blnMM) && $blnMM)? '/'.MM_CODE: ''; ?>" target="_blank">
                ...
                <div class="row">
                    ...
                    //print_r($dataRow);
                        ...
                        ?>
                         <tr>
                            <td colspan="22">
                                 <div class="" style="text-align: center; font-size: 12px; "><b><span>TBSU Region:<?php echo $dataRow['info']->tbis01name; ?></span></div>
                            </td>
                          </tr>
           <?php
