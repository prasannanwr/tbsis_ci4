...
<div class="alignRight"> 
        <form method="post" action="<?php echo site_url();?>/reports/Eng_Desing_Cost_Estimate_print<?php echo (isset($blnMM) && $blnMM)? '/'.MM_CODE: ''; ?>" target="_blank">
       ...
       <input type="submit"  class="btn btn-md btn-success" name="submit" value="Print" onclick="window.print();return false;" />
            ...
            <div class="container-fluid">
				...
				<div class="row">
                        ...
                        <tr>
                        <td colspan="30">
                              <div class="col-lg-6" style="line-height: 18px;"><b><span>District:<?php echo $dataRow['dist']->dist01name; ?></span></b></div><div class="col-lg-6"><b><span style="float:right;" >Development Region:<?php echo $dataRow['dist']->dev01name; ?></span></b></div>
								<div class="col-lg-6" style="line-height: 18px;"><b><span>TBSU Regional Office:<?php echo $dataRow['dist']->tbis01name; ?></span></b></div><!--<div class="col-lg-6"><b><span style="float:right;">Development Region</span></b></div>-->                    
