...
<div class="alignRight"> 
        <form method="post" action="<?php echo site_url();?>/reports/Work_Cancelled_Bridges_print<?php echo (isset($blnMM) && $blnMM)? '/'.MM_CODE: ''; ?>" target="_blank">
       ...
       <input type="submit"  class="btn btn-md btn-success" name="submit" value="Print" onclick="window.print();return false;" />
            ...
            <div class="container-fluid  " style="width:1200px; font-size:9px;">
                <div class="row">
					<div class="col-lg-12  ">
						...
						<div class=" table-responsive">
                            <table class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th style="width:36px;" class="center" rowspan="2" >SNaaaaa</th>
                    ...
                    reset($dataRow);$first_key = key($dataRow);
                       ?>
                        ...
                        <b><span>Development Region:&nbsp;</span><span class="bold "> <?php echo $dataRow[$first_key][0]->dev01name ;?></span></b>
                         ...
                         <?php $i=1; foreach($dataRow1 as $dataRow2){ //var_dump($dataRow2); ?>
                    	<tr>
                        	<td><?php echo $i;?></td>
