				...
				<div class="row">
                    ...
                    <div class="alignRight"> 
                        ...
                        ?>
							...
							<section class="rptInfo distcol"  id="BasicData">
                               <h2 style="border-bottom: 1px solid #000000; margin-top: 20px; text-align: center;">district name:<?php echo $arrDevInfo->dist01name; ?></h2>
							...
							<section class="rptInfo" id="Location">
								<h3 class="reportSubHeader">LOCATION</h3>
								<div class="col-lg-12">
									<div class="row">
									<div class="col-lg-4">
							...
							<section class="rptInfo2" id="BasicTechnicalData">
								<h3 class="reportSubHeader">BASIC TECHNICAL DATA:</h3>
									<div class="col-lg-12">
							...
							<div class="costNContri">
								<h3 class="reportSubHeader">Actual Bridge Cost and Contribution</h3>
								<div class="table-responsive col-lg-12">
									<table class="table table-bordered table-hover">
										<thead>
											<tr>
												<th rowspan="3" class="center"></th>
												<th colspan="13" class="center">Actual Bride Cost in NRs.</th>
											</tr>
									...
									<div class="row">
									<section class="rptTC" id="TotalCost">
										<div class="col-lg-12">
											<div class="row">
											<div class="col-lg-6">
