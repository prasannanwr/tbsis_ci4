...
<div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<div class="row">
                   ...
                   <form action="<?php echo site_url();?>/reports/tbss_regionwise_report/<?php echo $major;?>" method="post" />  
               ...
               <?php if(is_array($arrDistList)){ ?>
                        <select name="selDist" class="form-control">
                          <?php foreach($arrDistList as $dataRow){ ?>
                            <option value="<?php  echo $dataRow->tbis01id ;?>"><?php echo $dataRow->tbis01name ; ?></option>
