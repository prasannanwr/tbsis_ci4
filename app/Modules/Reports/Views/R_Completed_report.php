			...
			<div class="col-lg-12 mainBoard">
				...
				?>
						<?php if ($rtype == "district") { ?>
							...
							<div class="col-lg-6"><b><span style="float:right;">Status as of <?php echo _day(); ?></span></b></div>
							<div class="col-lg-6"><b><span>Development Region:&nbsp;</span><span class="bold "> <?php echo $dataRow['dist']['dev01name'];  ?></span></b></div>
						<?php } else { ?>
							<div class="col-lg-6"><b><span>TBSU Regional Office: <?php echo $tbsu_regional_off['tbis01name'];  ?></span></b></div>
							<div class="col-lg-6"><b><span style="float:right;">Status as of <?php echo _day(); ?></span></b></div>
							<!-- <div class="col-lg-6"><b><span>Development Region:&nbsp;</span><span class="bold "> <?php //echo $dataRow['dist']->dev01name;  
																														?></span></b></div>			 -->
						<?php } ?>
								...
								<thead>
									<tr>
										...
										<th rowspan="2" style="width:45px">
											...
											<div class="vertical-text__inner">Deviation in Construction Period</div>
										</th>
									</tr>
									<th>Number</th>
									<th>Name</th>
									...
									<th style="width:45px">
										<div class="vertical-text">
											<div class="vertical-text__inner">Width(Cm)</div>
										</div>
									</th>
									<th style="width:45px">
										<div class="vertical-text">
											<div class="vertical-text__inner">Site Assessment And Survey</div>
										</div>
									</th>
									<th style="width:45px">
										<div class="vertical-text">
											<div class="vertical-text__inner">Community Agrement</div>
										</div>
									</th>
									<th style="width:45px">
										<div class="vertical-text">
											<div class="vertical-text__inner">DMBT</div>
										</div>
									</th>
									<th style="width:45px">
										<div class="vertical-text">
											<div class="vertical-text__inner">1st phase of construction</div>
										</div>
									</th>
									<th style="width:45px">
										<div class="vertical-text">
											<div class="vertical-text__inner">Material Supplied to UC</div>
										</div>
									</th>
									<th style="width:45px">
										<div class="vertical-text">
											<div class="vertical-text__inner">2nd Phase of Construction</div>
										</div>
									</th>
									<th style="width:45px">
										<div class="vertical-text">
											<div class="vertical-text__inner">Anchorage Concreating</div>
										</div>
									</th>
									<th style="width:45px">
										<div class="vertical-text">
											<div class="vertical-text__inner">Cable Pulling</div>
										</div>
									</th>
									<th style="width:45px">
										<div class="vertical-text">
											<div class="vertical-text__inner">Bridge Completion</div>
										</div>
									</th>
									<th style="width:45px">
										<div class="vertical-text">
											<div class="vertical-text__inner">BMC Formation</div>
										</div>
									</th>
									<th style="width:45px">
										<div class="vertical-text">
											<div class="vertical-text__inner">Target Completion</div>
										</div>
									</th>
