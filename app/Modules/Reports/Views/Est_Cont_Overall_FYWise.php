...
<div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row center">
                    <h3>Estimated Conribution Commitment Overall FY Wise </h3>
				...
				<div class="row">
                   ...
                   <form action="<?php echo site_url();?>/reports/Est_Cont_Overall_FYWise_report<?php echo (isset($blnMM) && $blnMM)? '/'.MM_CODE: ''; ?>" method="post"> 
