...
<div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row center">
                    <h3>Design and Cost Estimate DateWise Report</h3>
				...
				<div class="row">
                   ...
                   <form action="<?php echo site_url();?>/reports/Eng_Desing_Cost_Estimate_report<?php echo (isset($blnMM) && $blnMM)? '/'.MM_CODE: ''; ?>" method="post"> 
