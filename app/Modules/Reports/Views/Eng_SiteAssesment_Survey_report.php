...
<div class="alignRight"> 
        <form method="post" action="<?php echo site_url();?>/reports/Eng_SiteAssesment_Survey_print<?php echo (isset($blnMM) && $blnMM)? '/'.MM_CODE: ''; ?>" target="_blank">
       ...
       <input type="submit"  class="btn btn-md btn-success" name="submit" value="Print" onclick="window.print();return false;" />
            ...
            <div class="container-fluid">
				...
				<div class="row">
							<div class="col-lg-12">
								<p class="reportHeader center">Site Assessment and Survey</p>
