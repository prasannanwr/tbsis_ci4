...
class Eng_Desing_Cost_Estimate_report extends BaseController
{
                ...
                $arrDistList = $this->view_district_new_reg_office_model->findAll();
                    ...
                    foreach($arrDistList as $dist) {
                      array_push($arrDists, $dist->dist01id);                      
                        ...
                        where('bri05bridge_complete <=', $dateEnd)->where('bri05bridge_design_estimate_check ', '1')->
                   ...
                   // die();
                    ...
                    redirect("reports/Eng_Desing_Cost_Estimate/".$stat);   
                }
              }else{
                'start date is Smaller than End Date';
              }
              return view('\Modules\Reports\Views\Eng_Desing_Cost_Estimate_report', $data);
