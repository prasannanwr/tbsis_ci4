    ...
    <div id="" class="dashboard-bg">
        <div class="container-fluid">
            <div class="panel panel-default">
                ...
                <div id="infoMessage" class="alert alert-info">No District found.</div>
                <?php else: ?>
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <?php $i=1; foreach ($arrDataList as $objData):?>
                            <tr class="active">
                                ...
                                <td><?php echo $objData->dist01code; ?></td>
                                <td><?php echo $objData->dist01state; ?></td>
                                
                                <td>
                                    <?php if (check_access_general(array('emp_edit'))): ?>
                                    <?php echo anchor("district_name/create/".$objData->dist01id, '<span class="form-edit floatRight">
                                        <img src="'.base_url('images/edit-btn.png').'" width="15" height="15"></span>'); ?>
                                    <a class="confirmation" data-href="<?php echo site_url('district_name');?>/delete/<?php echo $objData->dist01id;?>" data-toggle="confirmation"  data-singleton="true" data-placement="left" data-btnOkClass="btn-danger" data-btnCancelClass="btn-success" data-title="Are you sure to delete?" data-data accesskey="ss" >
