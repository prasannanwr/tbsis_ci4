...
<div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row center">
                    <h3>List of Completed Bridges (Agency Wise)</h3>
				...
				<div class="row">
                   ...
                   <form action="<?php echo site_url();?>/reports/Gen_TBSS_DateWise_report<?php echo (isset($blnMM) && $blnMM)? '/'.MM_CODE: ''; ?>" method="post"> 
