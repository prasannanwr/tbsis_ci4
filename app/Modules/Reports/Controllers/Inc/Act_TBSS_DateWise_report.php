...
class Act_TBSS_DateWise_report extends BaseController
{
    ...
    public function index($stat = '')
    {
        ...
        if ($Postback == 'Back') {
            ...
            if ($dataStart != 0 || $dateEnd != 0) {
                    ...
                    foreach ($data['arrDevList'] as $k => $v) {
                        ...
                        if (is_array($arrDistList)) {
                            ...
                            foreach ($arrDistList as $k1 => $v1) {
                                ...
                                $arrBridgeList = $this->view_brigde_detail_model->where('bri05bridge_complete >=', $dataStart)->where('bri05bridge_complete <=', $dateEnd)->where('dist01id', $v1->dist01id)->asObject()->findAll();
                ...
                redirect("reports/Act_TBSS_DateWise/" . $stat);
            }
        } else {
            'start date is Smaller than End Date';
        }
        return view('\Modules\Reports\Views\Act_TBSS_DateWise_report', $data);
