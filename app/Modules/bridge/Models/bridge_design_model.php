...
class bridge_design_model extends Model
{
    ...
    protected $allowedFields    = [
        'b_id',
        'bri_bri_type_check',
        'bri_bri_type_deficiency',
        'bri_bri_type_action',
        'bri_cable_geo_check',
        'bri_cable_geo_deficiency',
        'bri_cable_geo_action',
        'bri_overall_design_check',
        'bri_overall_design_deficiency',
        'bri_overall_design_action',
        'bri_foundation_check',
        'bri_foundation_deficiency',
        'bri_foundation_action',
        'bri_env_con_check',
        'bri_env_con_deficiency',
        'bri_env_con_action',
        'bri_design_opt_check',
        'bri_design_opt_deficiency',
        'bri_design_opt_action',
        'bri_free_board_check',
        'bri_free_board_deficiency',
        'bri_free_board_action',
        'bri_design_status',
        'bri_design_span_check',
        'bri_design_span_deficiency',
        'bri_design_span_action',
