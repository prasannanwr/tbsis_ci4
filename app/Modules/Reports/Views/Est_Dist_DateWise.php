...
<div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row center">
                    <h3>Estimated Bridge Cost District Date Wise </h3>
				...
				<div class="row">
                   ...
                   <form action="<?php echo site_url();?>/reports/Est_Dist_DateWise_report<?php echo (isset($blnMM) && $blnMM)? '/'.MM_CODE: ''; ?>" method="post"> 
