...
<div class="alignLeft"> 
        <form method="get" name="frmProvinceFilter" action="<?php echo site_url();?>/reports/Gen_Dag_FYWise_report<?php echo (isset($blnMM) && $blnMM)? '/'.MM_CODE: ''; ?>">
                                    ...
                                    <table class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th rowspan="2" class="center" style="width:150px;">District</th>
...
//echo "<pre>";var_dump($dataRow['data']);exit;
                    foreach($dataRow['data'] as $dataRow1){
                       // echo "<pre>";var_dump($dataRow1);exit;
                    ...
                    ?>
                                        ...
                                        <tbody>
                                            ...
                                            <td style="width:55px;" class="center"><?php echo $i + 1; ?></td>
                                                ...
                                                <td style="width:120px;" class="center"><?php echo $dataRow1['dist01name']; ?></td>
                        ...
                        ?>
                        <tr>
                            <td colspan="4" class="center">Total per District: </td>
