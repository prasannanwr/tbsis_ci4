...
<div id="page-wrapper">
  ...
  <div class="container-fluid">
    ...
    <div class="row center">
      <h3>UC Proportion Representation Report</h3>
    ...
    <div class="row">
      ...
      <div class="col-lg-5 clearfix">
        <form action="<?php echo site_url(); ?>/reports/UC_Proportion_Representation_FYWise_report<?php echo (isset($blnMM) && $blnMM) ? '/' . MM_CODE : ''; ?>" method="post">
