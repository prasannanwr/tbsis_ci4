...
<div class="alignRight"> 
        <form method="post" action="<?php echo site_url();?>/reports/Est_Cont_Dev_FYWise_print<?php echo (isset($blnMM) && $blnMM)? '/'.MM_CODE: ''; ?>" target="_blank">
       ...
       <input type="submit"  class="btn btn-md btn-success" name="submit" value="Print" onclick="window.print();return false;" />
            ...
            <div class="container-fluid">           
				<div class="row">
                                	...
                                	<table class="table table-bordered table-hover">
										<thead>
											<tr>
												...
												<th style="width:72px;" class="center" rowspan="2" >Total Contribution(NRs.)</th>
                                            </tr>
											<tr>
                 ...
                 <tr class="bdrTrBtm"><td colspan="22">
                  <div class="col-lg-12" style="text-align: center;"><b><strong>Development: <?php echo $dataRow['info']->dev01name; ?></strong></b></div>
                 </td></tr>
                    <?php
              ...
              <tr ><td colspan="22">
                               ...
                               <div class="col-lg-6"><b><span>TBSU Regional Office:<?php   echo $dataRow2['info']->tbis01name; ?></span></b></div><div class="col-lg-6"><b><span style="float:right;" >Development Region:<?php   echo $dataRow2['info']->dev01name; ?></span></b></div>
                       </td>  </tr>       
                                <!-- 3rd table-->
                    ...
                    <?php 
                        ...
                        foreach($arrCostSuppList as $dataRow5){ 
                            ...
                            <?php }?>
                            <td class="center est">
                                <label class="sumCalc colSumCostAmt" data-sum=".row<?php echo $i;?> .costAmt.bri_<?php echo $dataRow1['info']->bri03id;?>">0.00</label>
                             </td>
							</tr>
                     ...
                     <?php
                        ...
                        ?>
                          <tr>
                                ...
                                <?php
                                foreach($arrCostSuppList as $dataRow5){ ?>
                                <td class="center sumCalc total_<?php echo $dataRow5->sup01id;?> totalspan" data-sum=".dev_<?php echo $dataRow['info']->dev01id; ?>  .col<?php echo $dataRow5->sup01id;?>">0</td>
                                <?php } ?>
                            ...
                            <tr>
                                <td colspan="6" class="center">Average span and cost per span</td>
                                       <?php
                                foreach($arrCostSuppList as $dataRow5){ ?>
                                <td class="center calcPerc grstotal" data-numerator=".dev_<?php echo $dataRow['info']->dev01id; ?> .total_<?php echo $dataRow5->sup01id;?>.totalspan" data-denominator=".dev_<?php echo $dataRow['info']->dev01id; ?> .summerytotal">0</td>
                                <?php } ?>
                                <td class="center sumCalc " data-sum=".dev_<?php echo $dataRow['info']->dev01id; ?>  .grstotal"></td> 
         ...
         <div class="footer_border1">
            <div class="col-lg-8"><span>Bridge Type*: </span><span>SD=Suspended-SSTB</span>&nbsp;<span> SN=Suspension-SSTB </span>&nbsp;<span> ST=Steel Truss </span>&nbsp;<span> RCC=Rainforced Cement Concrete</span></div>
             <div class="col-lg-4 right" style="padding-right: 10px;"><span><b>Reporting Period(Fiscal Year): <?php echo $startdate->fis01year; ?> To <?php echo $enddate->fis01year; ?></b></span></div>  
         </div>  
         <div class="clear"></div>                                
