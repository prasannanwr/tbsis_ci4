...
<div class="alignRight"> 
        <form method="post" action="<?php echo site_url();?>/reports/Est_Overall_FYWise_print<?php echo (isset($blnMM) && $blnMM)? '/'.MM_CODE: ''; ?>" target="_blank">
				...
				<div class="col-lg-12 mainBoard">
					...
					<div class=" table-responsive"> 
                       ...
                       $i=1; foreach($dataRow['arrChildList'] as $dataRow1){
                        ...
                        ?>
                                ...
                                <tr class="row<?php echo $i;?> dataRow">
                   ...
                   <?php 
                        ...
                        <tr>
                                ...
                                <?php
                                foreach($arrCostCompList as $dataRow5){ ?>
                                <td class="center sumCalc totalspan total_col<?php echo $dataRow5->cmp01id;?>" data-sum=".dist_<?php echo $dataRow['info']->dist01id; ?> .dataRow .col<?php echo $dataRow5->cmp01id;?>">0</td>
                                <?php } ?>
