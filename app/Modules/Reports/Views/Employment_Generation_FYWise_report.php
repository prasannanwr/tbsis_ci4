...
<div id="page-wrapper" class="largeRpt">
    ...
    <div class="alignRight">
        <form method="post" action="<?php echo site_url(); ?>/reports/Employment_Generation_FYWise_report<?php echo (isset($blnMM) && $blnMM) ? '/' . MM_CODE : ''; ?>" target="_blank">
    ...
    <div class="container-fluid" id="printArea">
        ...
        <div class="row">
            <div class="col-lg-12 mainBoard">
                ...
                <h2 class="reportHeader center">Employment Generation (Between <?php echo $startyear['fis01code'] . " - " . $endyear['fis01code']; ?>) as of <?php echo date("j F, Y"); ?></h2>
