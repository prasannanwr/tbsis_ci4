...
class Est_Cont_Dev_DateWise_report extends BaseController
{
    ...
    public function index($stat = '') 
    {
        ...
        } elseif ($dataStart <= $dateEnd)
        {
            ...
            {
                redirect("reports/Est_Cont_Dev_DateWise/".$stat);
            }
        } else
        {
            'start date is Smaller than End Date';
        }
              return view('\Modules\Reports\Views\Est_Cont_Dev_DateWise_report', $data);
