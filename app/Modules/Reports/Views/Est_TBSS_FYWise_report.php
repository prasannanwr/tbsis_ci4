...
<div class="alignRight"> 
        <form method="post" action="<?php echo site_url();?>/reports/Est_TBSS_FYWise_print<?php echo (isset($blnMM) && $blnMM)? '/'.MM_CODE: ''; ?>" target="_blank">
				...
				<div class="col-lg-12 mainBoard">
					...
					<div class=" table-responsive">                                
						<table class="table table-bordered table-hover">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th class="center" style="width:75px">WW Width</th>
                       ...
                       <td colspan="22">
                          <div class="row">
                            <div class="col-lg-6">
                                <b><span>TBSU Regional Office: <?php echo $dataRow['info']->tbis01name; ?></span></b>
                            </div>
                        </div>
                       </td>
                       </tr>
                  ...
                  <?php 
                        ...
                        <tr>
                                ...
                                <td class="center sumCalc summeryspan" data-sum=".tbis_<?php echo $dataRow['info']->tbis01id; ?>  .spw">0</td>
                                <td colspan="3" class="center"></td>
                                
                                <?php
                                foreach($arrCostCompList as $dataRow5){ ?>
                                <td class="center total_<?php echo $dataRow5->cmp01id;?> sumCalc totalspan" data-sum=".tbis_<?php echo $dataRow['info']->tbis01id; ?> .col<?php echo $dataRow5->cmp01id;?>">0</td>
                                <?php } ?>
                              ...
                              <!--  <td class="center divCalc avgsummerytotal" data-numerator=".dev_<?php // echo $dataRow['info']->dev01id; ?> .summerytotal" data-denominator=".dev_<?php // echo $dataRow['info']->dev01id; ?> .summeryspan">0</td> -->
                                <input type="hidden" class="cntCalc totalcnt" data-cnt=".tbis_<?php echo $dataRow['info']->tbis01id; ?> .spw" value=""/>
                                  <td class="center" > &nbsp;</td>                                                          
                            </tr>
                            <tr>
                                <td colspan="4" class="center">Average span and cost per span</td>
                                <td class="center divCalc grsspan" data-numerator=".tbis_<?php echo $dataRow['info']->tbis01id; ?> .summeryspan" data-denominator=".tbis_<?php echo $dataRow['info']->tbis01id; ?> .totalcnt" >0</td>
                                <td colspan="3" class="center"></td>
                                                            <?php
                                foreach($arrCostCompList as $dataRow5){ ?>
                                <td class="center divCalc grstotal" data-numerator=".tbis_<?php echo $dataRow['info']->tbis01id; ?> .total_<?php echo $dataRow5->cmp01id;?>.totalspan" data-denominator=".tbis_<?php echo $dataRow['info']->tbis01id; ?> .summeryspan">0</td>
                                <?php } ?>
                                  <td class="center" > &nbsp;</td> 
