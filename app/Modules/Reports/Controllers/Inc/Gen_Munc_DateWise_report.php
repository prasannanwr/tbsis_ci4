...
class Gen_Munc_DateWise_report extends BaseController
{
  ...
  public function index($stat = '')
  {
    ...
    if ($Postback == 'Back') {
      ...
      if ($dataStart != 0 || $dateEnd != 0) {
        ...
        $dist = $this->view_brigde_detail_model->where('left_muni01id', $bri03municipality)->findAll();
        ...
        redirect("reports/Gen_Munc_DateWise/" . $stat);
      }
    } else {
      'start date is Smaller than End Date';
    }

    return view('\Modules\Reports\Views\Gen_Munc_DateWise_report', $data);
  }
}
