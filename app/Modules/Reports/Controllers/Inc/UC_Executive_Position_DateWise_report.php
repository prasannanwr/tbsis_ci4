...
class UC_Executive_Position_DateWise_report extends BaseController
{
    ...
    public function index($stat = '')
    {
        ...
        $data['blnMM'] = $stat;
        $data['title'] = "UC Executive Position DateWise report";
        ...
        } elseif ($dateStart <= $dateEnd)
        {
                ...
                */
                ...
                if(is_array( $selDist)){
                    ...
                    foreach( $selDist as $k=>$v){
                        ...
                        if($stat == 2) { // under construction
                          $arrBridgeList = $this->bridge_uc_formation_model->getUCExecutivePositionUnderConsByDate($dateStart, $dateEnd, $rr);
                        } else {
                          $arrBridgeList = $this->bridge_uc_formation_model->getUCExecutivePositionByDate($dateStart, $dateEnd, $rr);
                        }
            ...
            {
                redirect("reports/UC_Executive_Position_DateWise/".$stat);
        ...
        return view('\Modules\Reports\Views\UC_Executive_Position_DateWise_report', $data);
