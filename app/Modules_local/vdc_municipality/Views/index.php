        ...
        <div class="panel panel-default">
            <div class="ShowForm-form ">
                ...
                <div class="AddBtn">
                    ...
                    ?>
                    <?php echo anchor('vdc_municipality/create', '<button type="button" class="btn btn-small"><i class="icon-user icon"></i> Create RM/UM</button>'); ?>
                    <?php //endif 
                    ?>
                </div>
...
<script>
    $(document).ready(function() {
        $url = '<?php echo site_url("vdc_municipality/ajaxData"); ?>';
            ...
            columns: [{
                ...
                },
                {
                    ...
                    mRender: function(data, type, full) {
                        //console.log( data );
                        return '<a href="<?php echo site_url(); ?>/vdc_municipality/create/' + data + '">' + $add + '</a> <a href="<?php echo site_url(); ?>/vdc_municipality/delete/?id=' + data + '">' + $del + '</a>';
                    }
                }
            ]
