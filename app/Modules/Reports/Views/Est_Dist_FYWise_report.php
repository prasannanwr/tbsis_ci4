...
<div class="alignRight"> 
        <form method="post" action="<?php echo site_url();?>/reports/Est_Dist_FYWise_print<?php echo (isset($blnMM) && $blnMM)? '/'.MM_CODE: ''; ?>" target="_blank">
                  ...
                  //var_dump($dataRow2);
                   ...
                   <?php 
                      ...
                      <tr>
                                ...
                                <?php
                                foreach($arrCostCompList as $dataRow5){ ?>
                                <td class="center sumCalc total_<?php echo $dataRow5->cmp01id;?> totalspan" data-sum=".dist_<?php echo $dataRow['info']->dist01id; ?> .col<?php echo $dataRow5->cmp01id;?>">0</td>
                                <?php } ?>
                            ...
                            <tr>
                                ...
                                <td colspan="3" class="center"></td>
                                                            <?php
                                foreach($arrCostCompList as $dataRow5){ ?>
                                <td class="center divCalc grstotal" data-numerator=".dist_<?php echo $dataRow['info']->dist01id; ?> .total_<?php echo $dataRow5->cmp01id;?>.totalspan" data-denominator=".dist_<?php echo $dataRow['info']->dist01id; ?> .summeryspan">0</td>
                                <?php } ?>
...
<!---footer-->  
         <div class="footer_border1">
            <div class="col-lg-8"><span>Bridge Type*: </span><span>SD=Suspended-SSTB</span>&nbsp;<span> SN=Suspension-SSTB </span>&nbsp;<span> ST=Steel Truss </span>&nbsp;<span> RCC=Rainforced Cement Concrete</span></div>
                                ...
                                <span><b>Reporting Period:<?php echo $startdate->fis01year; ?> To <?php echo $enddate->fis01year; ?></b></span>
                            </div>
