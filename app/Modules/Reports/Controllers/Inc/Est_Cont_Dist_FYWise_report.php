...
class Est_Cont_Dist_FYWise_report extends BaseController
{
  ...
  public function index($stat = '')
  {
    ...
    $data['endyear'] = $this->fiscal_year_model->where('fis01id', $dateEnd)->first();
        ...
        } elseif ($dataStart <= $dateEnd)
        {
            ...
            {
                redirect("reports/Est_Cont_Dist_FYWise/".$stat);
            }
        } else
        {
            'start date is Smaller than End Date';
        }
    return view('\Modules\Reports\Views\Est_Cont_Dist_FYWise_report', $data);
  }
}