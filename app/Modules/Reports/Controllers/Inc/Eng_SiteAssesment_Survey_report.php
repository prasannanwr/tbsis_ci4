...
class Eng_SiteAssesment_Survey_report extends BaseController
{
             ...
             elseif( $dataStart <= $dateEnd){
                ...
                $arrDistList = $this->view_district_new_reg_office_model->findAll();
                    ...
                    //print_r($arrDists);exit;
                        ...
                        where('bri05bridge_complete <=', $dateEnd)->where('bri05site_assessment_check ', '1')->
                   ...
                   // die();
                    ...
                    redirect("reports/Eng_SiteAssesment_Survey/".$stat);   
                }
              }else{
                'start date is Smaller than End Date';
              }
    return view('\Modules\Reports\Views\Eng_SiteAssesment_Survey_report', $data);
  }
}