            ...
            <div class="col-lg-12 mainBoard">
                ...
                <div class=" table-responsive">                                
                    <table class="table table-bordered table-hover">
                        ...
                        ?>
                        <tbody class="sup_<?php echo $arrSupData->tbis01id; ?>">
                        <tr>
                            <td colspan="22">
                    ...
                    ?>
                        ...
                        ?>
                        <tr><td colspan="20">Total Bridge under <?php echo $arrSupData->tbis01name; ?>: <?php echo $j-1;?></td></tr>                        
                         <tr>
                                <td colspan="7" class="center">Total span and cost per supporting </td>
                                 <?php
                                foreach($arrCostCompList as $dataRow5){ ?>
                                <td class="center sumCalc total_<?php echo $dataRow5->sup01id;?> totalspan" data-sum=".sup_<?php echo $arrSupData->tbis01id; ?> .col<?php echo $dataRow5->sup01id;?>">0</td>
                                <?php } ?>
                                <td class="center sumCalc summerytotal" data-sum=".sup_<?php echo $arrSupData->tbis01id; ?> .colSumCostAmt"></td> 
                                 
                                <input type="hidden" class="cntCalc totalcnt" data-cnt=".sup_<?php echo $arrSupData->tbis01id; ?> .spw"/>
                            ...
                            <tr>
                                ...
                                foreach($arrCostCompList as $dataRow5){ ?>
                                <td class="center calcPerc sup_<?php echo $arrSupData->tbis01id; ?> grstotal" data-numerator=".sup_<?php echo $arrSupData->tbis01id; ?> .totalspan.total_<?php echo $dataRow5->sup01id;?>" data-denominator=".sup_<?php echo $arrSupData->tbis01id; ?> .summerytotal">0</td>
                                <?php } ?>
                                <td class="center sumCalc " data-sum=".sup_<?php echo $arrSupData->tbis01id; ?>.grstotal"></td> 
