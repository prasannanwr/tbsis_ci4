...
<div class="alignRight"> 
        <form method="post" action="<?php echo site_url();?>/reports/Est_Cont_Overall_DateWise_print<?php echo (isset($blnMM) && $blnMM)? '/'.MM_CODE: ''; ?>" target="_blank">
				...
				<div class="row">
                    ...
                    //var_dump($dataRow2);
                     ...
                     <div class="col-lg-12"><b><span>District:<?php   echo $dataRow['info']->dist01name; ?></span></b></div>
                      ...
                      <tr>
                     <td colspan="22">
                     <div class="col-lg-6"><b><span>TBSU Regional Office:<?php   echo $dataRow['info']->tbis01name; ?></span></b></div><div class="col-lg-6"><b><span style="float:right;" >Development Region:<?php   echo $dataRow['info']->dev01name; ?></span></b></div>
                     </td>
                     </tr>
                   ...
                   <?php 
                        ...
                        foreach($arrCostSuppList as $dataRow5){ 
                            ...
                            <?php }?>
                            <td class="center est sumCalc colSumCostAmt" data-sum=".row<?php echo $i;?> .bri_<?php echo $dataRow1['info']->bri03id;?>.costAmt">
                                0.00
                             </td>
                        ...
                        ?>
                         <tr>
                                ...
                                <?php
                                foreach($arrCostSuppList as $dataRow5){ ?>
                                <td class="center sumCalc totalspan total_<?php echo $dataRow5->sup01id;?>" data-sum=".dist_<?php echo $dataRow['info']->dist01id; ?>  .col<?php echo $dataRow5->sup01id;?>">0</td>
                                <?php } ?>
                            ...
                            <tr>
                                <td colspan="6" class="center">Percentage per District</td>
                                         <?php
                                foreach($arrCostSuppList as $dataRow5){ ?>
                                <td class="center calcPerc grstotal" data-numerator=".dist_<?php echo $dataRow['info']->dist01id; ?> .total_<?php echo $dataRow5->sup01id;?>.totalspan" data-denominator=".dist_<?php echo $dataRow['info']->dist01id; ?> .summerytotal">0</td>
                                <?php } ?>
