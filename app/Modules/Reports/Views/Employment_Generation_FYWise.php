...
<div id="page-wrapper">
  ...
  <div class="container-fluid">
    ...
    <div class="row center">
      <h3>Employment Generation Report</h3>
    ...
    <div class="row">
      ...
      <div class="col-lg-5 clearfix">
        <form action="<?php echo site_url(); ?>/reports/Employment_Generation_FYWise_report<?php echo (isset($blnMM) && $blnMM) ? '/' . MM_CODE : ''; ?>" method="post">
