                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            if(isset($arrPrintList) && is_array($arrPrintList)){
                                ...
                                foreach($arrPrintList as $dataRow){
                                    ...
                                    //total per district
//                                    $dalit_total_per_dist = $dalit_total/$total_household;
//                                    $janjati_total_per_dist = $janjati_total/$total_household;
//                                    $minorities_total_per_dist = $minorities_total/$total_household;
//                                    $bct_total_per_dist = $bct_total/$total_household;
                                    ?>
                                    <tr>
                                    ...
                                    <?php
                                    $g_total_household += $total_household;
                                    $g_total_beneficiaries += $total_beneficiaries;
                                    $g_dalit_total += $dalit_total;
                                    $g_janjati_total += $janjati_total;
                                    $g_minorities_total += $minorities_total;
                                    $g_bct_total += $bct_total;
                                    $g_grand_total += $grand_total;
