...
class bridge_beneficiaries_model extends Model
{
    ...
    public function getBeneficiaries($startDate = '', $endDate = '', $distId, $perPage = 10, $offset = 0) {
