...
<div class="alignRight"> 
        <form method="post" action="<?php echo site_url();?>/reports/Est_Cont_TBSS_DateWise_print<?php echo (isset($blnMM) && $blnMM)? '/'.MM_CODE: ''; ?>" target="_blank">
            ...
            <div class="container-fluid">           
				<div class="row">
					<div class="col-lg-12">
                     ...
                     <tr>
                      <td colspan="22">
                       <div class="col-lg-12 center" ><b><strong>TBSU Regional Office:<?php echo $dataRow['info']->tbis01name; ?></strong></b></div>
                      </td>
                     </tr>   
                  ...
                  //var_dump($dataRow2);
                     ...
                     <tr>
                     <td colspan="22">
                      <div class="col-lg-6"><b><span>Development:<?php   echo $dataRow2['info']->dev01name; ?></span></b></div><div class="col-lg-6"><b><span style="float:right;" >Development Region:<?php   echo $dataRow2['info']->dev01name; ?></span></b></div>
                     </td>
                     </tr>
                     ...
                     <?php
                        ...
                        ?>
                         <tr>
                                ...
                                <?php
                                foreach($arrCostSuppList as $dataRow5){ ?>
                                <td class="center sumCalc total_<?php echo $dataRow5->sup01id;?> totalspan" data-sum=".tbis_<?php echo $dataRow['info']->tbis01id; ?>  .col<?php echo $dataRow5->sup01id;?>">0</td>
                                <?php } ?>
                            ...
                            <tr>
                                <td colspan="6" class="center">Average span and cost per span</td>
                                       <?php
                                foreach($arrCostSuppList as $dataRow5){ ?>
                                <td class="center calcPerc grstotal" data-numerator=".tbis_<?php echo $dataRow['info']->tbis01id; ?> .total_<?php echo $dataRow5->sup01id;?>.totalspan" data-denominator=".tbis_<?php echo $dataRow['info']->tbis01id; ?> .summerytotal">0</td>
                                <?php } ?>
                                <td class="center sumCalc " data-sum=".tbis_<?php echo $dataRow['info']->tbis01id; ?>  .grstotal"></td> 
                            </tr>
                        </tbody>
                       <?php 
                        }//if isset close
