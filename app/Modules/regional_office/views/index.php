    	...
    	<div class="container-fluid">
    		<div class="panel panel-default">
                ...
                <div class="AddBtn">
            	    ...
            	    <?php echo anchor('regional_office/create', '<button type="button" class="btn btn-small"><i class="icon-user icon"></i> Create Regional Office</button>'); ?>
            	    <?php //endif ?>
               </div>
                    ...
                    <table class="table table-bordered table-hover table-striped">
                    	...
                    	<?php $i=1; foreach ($arrDataList as $objData):?>
                    		<tr class="active">
                    			...
                    			<td><?php echo $i++;?></td>
                    			<td>
                    				<?php // echo anchor('zone/view/'.$objData->tbis01id, $objData->tbis01name); ?>
                    			<?php echo $objData->tbis01name; ?>
                                 </td>
                    			
                    			<td>
                    				<?php echo $objData->tbis01address; ?>
                    			</td>
                    			<td>
                    				<?php if (check_access_general(array('emp_edit'))): ?>
                    				<?php echo anchor("regional_office/create/".$objData->tbis01id, '<span class="form-edit floatRight">
                                        <img src="'.base_url().'/images/edit-btn.png" width="15" height="15"></span>'); ?>
                                            <a class="confirmation" data-href="<?php echo site_url('regional_office');?>/delete/<?php echo $objData->tbis01id;?>" data-toggle="confirmation"  data-singleton="true" data-placement="left" data-btnOkClass="btn-danger" data-btnCancelClass="btn-success" data-title="Are you sure to delete?" data-data accesskey="ss" >
