...
class bridge_cost_estimate_model extends Model
{
    ...
    protected $allowedFields    = [
        ...
        'bri_impl_approach_lstb_check',
        'bri_impl_approach_lstb_deficiency',
        'bri_impl_approach_lstb_remarks',
        'bri_unit_rates_steel_check',
        'bri_unit_rates_steel_deficiency',
        'bri_unit_rates_steel_remarks',
        'bri_unit_rates_check',
        'bri_unit_rates_deficiency',
        'bri_unit_rates_remarks',
        'bri_portering_dis_check',
        'bri_portering_dis_deficiency',
