...
<div class="alignRight"> 
        <form method="post" action="<?php echo site_url();?>/reports/Unacceptable_Social_UnderConstruction<?php echo (isset($blnMM) && $blnMM)? '/'.MM_CODE: ''; ?>" target="_blank">
                    ...
                    <div class="col-lg-12 mainBoard">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th style="width:160px;" rowspan="2" class="center">Issues</th>
                                                <th style="width:160px;" rowspan="2" class="center">Remarks</th>
                                            </tr>
                                        </thead>
...
?>
                    ...
                    ?>
                        ...
                        <div class="mt-3">
                            ...
                            <?php if ($pager):?>
                                <?php $pagi_path = 'reports/Unacceptable_Social_UnderConstruction?dataStart='.$dataStart; ?>
