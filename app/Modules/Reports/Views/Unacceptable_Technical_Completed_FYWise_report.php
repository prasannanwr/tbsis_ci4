...
<div class="alignLeft"> 
        <form method="post" name="frmProvinceFilter" action="<?php echo site_url();?>/reports/Unacceptable_Technical_Completed_FYWise_report<?php echo (isset($blnMM) && $blnMM)? '/'.$blnMM: ''; ?>" >
