...
<div class="alignRight"> 
        <form method="post" action="<?php echo site_url();?>/reports/Est_Cont_Overall_FYWise_print<?php echo (isset($blnMM) && $blnMM)? '/'.MM_CODE: ''; ?>" target="_blank">
                      ...
                      <tr>
                            ...
                            <tr>
                                <td colspan="6" class="center">Percentage per District</td>
                                         <?php
                                foreach($arrCostSuppList as $dataRow5){ ?>
                                <td class="center calcPerc grstotal" data-numerator=".dist_<?php echo $dataRow['info']->dist01id; ?> .total_<?php echo $dataRow5->sup01id; ?>" data-denominator=".dist_<?php echo $dataRow['info']->dist01id; ?> .summerytotal.dist_<?php echo $dataRow['info']->dist01id; ?>">0</td>
                                <?php } ?>
