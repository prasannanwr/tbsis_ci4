...
<div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row center">
                    <h3>District Wise List of Completed Bridges</h3>
				...
				<div class="row">
                   ...
                   <form action="<?php echo site_url();?>/reports/Gen_Dist_FYWise_report<?php echo (isset($blnMM) && $blnMM)? '/'.MM_CODE: ''; ?>" method="post"> 
