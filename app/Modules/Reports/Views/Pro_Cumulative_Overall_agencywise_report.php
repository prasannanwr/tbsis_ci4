            ...
            <div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12 mainBoard">
							...
							<div class="col-lg-12">
								<div class="reportHeader" style="text-align:center;">Summary progress report of Bridge(s) funded through <?php echo $supportingAgency->sup01sup_agency_name;?> between <?php echo $startyear->fis01year."-".$endyear->fis01year;?> as of <?php echo date("j F, Y");?></div>
					...
					/*echo $sID;
					echo "<br>";
					echo $arrDistInfo->dist01id;
					echo "<br>";
					echo $startyear->fis01year;
					exit;*/
					
					//$fiscaldata = $procumOverall->getFiscalData($sID,$arrDistInfo->dist01id,$startyear->fis01year);
					$fiscaldata = $procumOverall->getFiscalData($sID,$arrDistInfo->dist01id,$startyear->fis01year,$blnMM);
...
//
                 if($arrDistInfo != '') {
                    if( $arrDistInfo !== 'dist_'  ){
                    	...
                    	//$new_commit_tot = $new_commit_tot + $dataRow1['pipeline'];
